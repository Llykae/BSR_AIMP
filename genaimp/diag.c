...
/*----------------------------------------------------------------------------------------
   rdiag() computes the diagonalization of the real square matrix and its eignevectors:   
...
------------------------------------------------------------------------------------------*/
void rdiag(int pmax, double **edet, double *ehh, double **yhh) 
{
   void tred2();  
   void tqli();	   			
   void eigsrt();
...
double sum1,sum2;
double **ttr,**tti;
ttr = dmatrix(1,nmax,1,nmax);
tti = dmatrix(1,nmax,1,nmax);
