...
void initatm(int ntot, struct atom_dat **at_dt)
{
 ...
 int iat,i;
   ...
   for(iat=1;iat<=ntot;iat++)
      {
       fscanf(fdin,"%s %d %d %le",(*at_dt)[iat].element,&(*at_dt)[iat].imol,&(*at_dt)[iat].zat ,&(*at_dt)[iat].m);				fgets(strtmp,200,fdin);
       fscanf(fdin,"%le %le %le",&(*at_dt)[iat].r[1],&(*at_dt)[iat].r[2],&(*at_dt)[iat].r[3]);							fgets(strtmp,200,fdin);
       fscanf(fdin,"%le %le %le",&(*at_dt)[iat].p[1],&(*at_dt)[iat].p[2],&(*at_dt)[iat].p[3]);							fgets(strtmp,200,fdin);
