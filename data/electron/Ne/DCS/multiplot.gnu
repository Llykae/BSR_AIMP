...
set output "./output/DCS/Ne/Ne_multiplot_DCS_6L.jpeg"

set multiplot layout 2,2

set title "Differential Cross-Section at 5 eV"
plot "./output/DCS/Ne/With_Correction/DCS_5eV.out" u 1:($2*0.529*0.529) w l t'Simulation with Correction',\
"./output/DCS/Ne/Without_Correction/DCS_5eV.out" u 1:($2*0.529*0.529) with lines lt 0 lw 2 dt " _ " lc 8  t'Simulation without Correction',\
...
plot "./output/DCS/Ne/With_Correction/DCS_10eV.out" u 1:($2*0.529*0.529) w l t'Simulation with Correction',\
"./output/DCS/Ne/Without_Correction/DCS_10eV.out" u 1:($2*0.529*0.529) with lines lt 0 lw 2 dt "..." lc 8  t'Simulation without Correction',\
...
plot "./output/DCS/Ne/With_Correction/DCS_15eV.out" u 1:($2*0.529*0.529) w l t'Simulation with Correction',\
"./output/DCS/Ne/Without_Correction/DCS_15eV.out" u 1:($2*0.529*0.529) with lines lt 0 lw 2 dt  "..." lc 8 t'Simulation without Correction',\
...
plot "./output/DCS/Ne/With_Correction/DCS_20eV.out" u 1:($2*0.529*0.529) w l t'Simulation with Correction',\
"./output/DCS/Ne/Without_Correction/DCS_20eV.out" u 1:($2*0.529*0.529) with lines lt 0 lw 2 dt "..." lc 8 t'Simulation without Correction',\
